...
//  TextSelection get _selection => _value.selection;
  TextSelection get _selection {
    if (_value.selection.affinity == null) {
      _value = TextEditingValue(text: _value.text,selection:TextSelection(
        baseOffset: _value.selection.baseOffset,
        extentOffset: _value.selection.extentOffset,
        affinity: TextAffinity.upstream,
        isDirectional:_value.selection.isDirectional,
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final Rect editingRegion = Rect.fromPoints(
      renderObject.getlocalToGlobal(Offset.zero),
      renderObject
          .getlocalToGlobal(renderObject.getSize().bottomRight(Offset.zero)),
    );
...
class _TextSelectionHandleOverlayState
  ...
  Widget build(BuildContext context) {
    ...
    final Size viewport = widget.renderObject.getSize();
    point = Offset(
